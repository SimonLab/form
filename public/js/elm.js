...
var _user$project$Answer$replyEncoder = function (model) {
	return _elm_lang$core$Json_Encode$object(
		A2(
			...
			_elm_lang$core$Dict$toList(model.replies)));
};
var _user$project$Answer$viewThankYou = A2(
	_elm_lang$html$Html$div,
	{ctor: '[]'},
	{
		ctor: '::',
		_0: _elm_lang$html$Html$text('Thank you for the answers'),
		_1: {ctor: '[]'}
	});
var _user$project$Answer$subscriptions = function (model) {
	return _elm_lang$core$Platform_Sub$none;
};
var _user$project$Answer$Flags = F3(
	function (a, b, c) {
		return {id: a, title: b, questions: c};
	});
...
var _user$project$Answer$Model = F5(
	function (a, b, c, d, e) {
		return {id: a, title: b, questions: c, replies: d, completed: e};
	});
...
var _user$project$Answer$ReplySubmit = function (a) {
	return {ok: a};
};
var _user$project$Answer$replyDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ok',
	_elm_lang$core$Json_Decode$bool,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Answer$ReplySubmit));
var _user$project$Answer$Reply = function (a) {
	return {ctor: 'Reply', _0: a};
};
var _user$project$Answer$submitAnswer = function (model) {
		...
		_elm_lang$core$Json_Encode$object(
			{
				...
				_1: {
					...
					_0: {
						ctor: '_Tuple2',
						_0: 'answers',
						_1: _user$project$Answer$replyEncoder(model)
					},
					_1: {ctor: '[]'}
				}
			}));
	return A2(
		...
		_user$project$Answer$Reply,
		A3(_elm_lang$http$Http$post, '/form/reply', body, _user$project$Answer$replyDecoder));
};
var _user$project$Answer$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'SelectAnswer':
				var replies = A3(_elm_lang$core$Dict$insert, _p2._0, _p2._1, model.replies);
				return A2(
					_elm_lang$core$Platform_Cmd_ops['!'],
			...
			case 'Submit':
				return {
					ctor: '_Tuple2',
					_0: model,
					_1: _user$project$Answer$submitAnswer(model)
				};
			default:
				if (_p2._0.ctor === 'Ok') {
					return A2(
...
var _user$project$Answer$view = function (model) {
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_1: {
				ctor: '::',
				_0: (!model.completed) ? _user$project$Answer$viewQuestions(model.questions) : _user$project$Answer$viewThankYou,
				_1: {ctor: '[]'}
			}
		});
};
					...
					return A2(
						...
						function (title) {
							return _elm_lang$core$Json_Decode$succeed(
								{id: id, questions: questions, title: title});
						},
	...
	return _elm_lang$core$Json_Encode$object(
		{
			...
			_0: {
				ctor: '_Tuple2',
				_0: 'question',
				_1: _elm_lang$core$Json_Encode$string(question.question)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _elm_lang$core$Json_Encode$string, question.answers))
				},
				_1: {ctor: '[]'}
			}
		});
};
var _user$project$Form$formEncoder = function (model) {
	return _elm_lang$core$Json_Encode$object(
		{
			ctor: '::',
			_0: {
				ctor: '_Tuple2',
				_0: 'title',
				_1: _elm_lang$core$Json_Encode$string(model.formTitle)
			},
			_1: {
				ctor: '::',
				_0: {
					...
					_0: 'questions',
					_1: _elm_lang$core$Json_Encode$list(
						A2(_elm_lang$core$List$map, _user$project$Form$questionEncoder, model.questions))
				},
				_1: {ctor: '[]'}
			}
		});
...
var _user$project$Form$init = A2(
	...
	{ctor: '[]'});
var _user$project$Form$Reply = function (a) {
	return {ok: a};
};
var _user$project$Form$formDecoder = A3(
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$required,
	'ok',
	_elm_lang$core$Json_Decode$bool,
	_NoRedInk$elm_decode_pipeline$Json_Decode_Pipeline$decode(_user$project$Form$Reply));
var _user$project$Form$ReplyForm = function (a) {
	return {ctor: 'ReplyForm', _0: a};
};
var _user$project$Form$publishForm = function (model) {
	...
	return A2(
		...
		A3(_elm_lang$http$Http$post, '/form/create', body, _user$project$Form$formDecoder));
};
...
var _user$project$Form$PublishForm = {ctor: 'PublishForm'};
...
var _user$project$Form$questionFormView = function (model) {
	return A2(
		_elm_lang$html$Html$div,
		{ctor: '[]'},
		{
			...
			_1: {
				...
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Form$QuestionText),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Question'),
							_1: {
								ctor: '::',
								_0: _elm_lang$html$Html_Attributes$value(
									_user$project$Form$getQuestionValue(model.currentQuestion)),
								_1: {ctor: '[]'}
							}
						}
					},
...
var _user$project$Form$Title = function (a) {
				...
				{ctor: '[]'},
				{
					...
					_0: _elm_lang$html$Html$text(
						A2(
							_elm_lang$core$Basics_ops['++'],
							'New Form: ',
							_user$project$Form$getTitle(model.formTitle))),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Events$onInput(_user$project$Form$Title),
						_1: {
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$placeholder('Title of the form'),
							_1: {ctor: '[]'}
						}
					},
					{ctor: '[]'}),
				_1: {
					...
					_1: {
						ctor: '::',
						_0: _user$project$Form$questionFormView(model),
						_1: {
							ctor: '::',
							_0: A2(
								_elm_lang$html$Html$p,
							...
							_1: {
								...
								_1: {
									...
									_0: A2(
										...
										{
											ctor: '::',
											_0: _elm_lang$html$Html_Events$onClick(_user$project$Form$PublishForm),
											_1: {ctor: '[]'}
										},
										{
											ctor: '::',
											_0: _elm_lang$html$Html$text('Publish form'),
											_1: {ctor: '[]'}
										}),
									_1: {ctor: '[]'}
								}
...
var _user$project$Form$main = _elm_lang$html$Html$program(
	{init: _user$project$Form$init, update: _user$project$Form$update, subscriptions: _user$project$Form$subscriptions, view: _user$project$Form$view})();
	...
	return A2(
		...
		{ctor: '[]'},
		{
			...
			_0: A2(
				...
				{
					ctor: '::',
					_0: _elm_lang$html$Html$text('Create your own forms!'),
					_1: {ctor: '[]'}
				}),
			_1: {
				ctor: '::',
				_0: A2(
					...
					{
						ctor: '::',
						_0: _elm_lang$html$Html_Attributes$href('/form/new'),
						_1: {ctor: '[]'}
					},
					{
						ctor: '::',
						_0: _elm_lang$html$Html$text('Create new form'),
						_1: {ctor: '[]'}
					}),
				_1: {ctor: '[]'}
			}
...
var _user$project$Index$subscriptions = function (_p0) {
	return _elm_lang$core$Platform_Sub$none;
};
...
var _user$project$Index$Nothing = {ctor: 'Nothing'};
var _user$project$Index$init = A2(
	_elm_lang$core$Platform_Cmd_ops['!'],
	_user$project$Index$Nothing,
	{ctor: '[]'});
var _user$project$Index$main = _elm_lang$html$Html$program(
	{init: _user$project$Index$init, update: _user$project$Index$update, subscriptions: _user$project$Index$subscriptions, view: _user$project$Index$view})();
